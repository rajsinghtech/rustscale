...
/// Geneve protocol type for disco control messages (matches Go's
/// `packet.GeneveProtocolDisco = 0x7A11`).
pub const GENEVE_PROTOCOL_DISCO: u16 = 0x7A11;

/// Geneve protocol type for WireGuard data (matches Go's
/// `packet.GeneveProtocolWireGuard = 0x7A12`).
