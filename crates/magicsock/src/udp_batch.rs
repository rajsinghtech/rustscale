...
/// scratch, leaving exactly 2176 independently reserved detachable buffers.
/// This is exactly 4.5 MiB of pooled fast-path payload storage; separate
...
pub(crate) const RECEIVE_BUFFER_POOL_CAPACITY: usize = 2304;
