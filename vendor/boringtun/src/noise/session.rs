...
impl Session {
    ...
    pub(super) fn receiving_counter_quick_check(&self, counter: u64) -> Result<(), WireGuardError> {
    ...
    pub(super) fn mark_received(&self, counter: u64) -> Result<(), WireGuardError> {
    ...
    pub(super) fn receive_packet_data<'a>(
        ...
        let ret = self.open_packet_data_unchecked(packet, dst)?;
